		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("cgd", require("telescope.builtin").lsp_definitions, "[G]oto [D]efinition")

					-- Find references for the word under your cursor.
					map("cgr", require("telescope.builtin").lsp_references, "[G]oto [R]eferences")

					-- Jump to the implementation of the word under your cursor.
					--  Useful when your language has ways of declaring types without an actual implementation.
					map("cgI", require("telescope.builtin").lsp_implementations, "[G]oto [I]mplementation")
					...
					map("<leader>crv", vim.lsp.buf.rename, "[R]ename [v]ariables")
					...
					map("cd", vim.lsp.buf.hover, "[C]ode [D]ocumentation")

					-- WARN: This is not Goto Definition, this is Goto Declaration.
					--  For example, in C this would take you to the header.
					map("cgd", vim.lsp.buf.declaration, "[G]oto [D]eclaration")
	...
	{ -- Highlight, edit, and navigate code
		...
		opts = {
			...
			highlight = {
				...
				--  If you are experiencinghweird indenting issues, add the language to
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			require("which-key").register({
				...
				["<leader><Tab>"] = { name = "Workspace", _ = "which_key_ignore" },
			})
		end,
	},
})
...
-- NOTE: clears search highlight
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>")

-- Sessions
vim.keymap.set("n", "<leader>qs", scripts.session_save, { desc = "Session [S]ave" })
vim.keymap.set("n", "<leader>ql", scripts.session_load, { desc = "Session [L]oad" })
vim.keymap.set("n", "<leader>qd", scripts.session_delete, { desc = "Session [D]elete" })

-- Projects
vim.keymap.set("n", "<leader>pp", workspaces.open, { desc = "[P]roject o[p]en" })
vim.keymap.set("n", "<leader>pa", workspaces.add, { desc = "[P]roject [a]dd" })
vim.keymap.set("n", "<leader>pr", workspaces.rename, { desc = "[P]roject [r]ename" })
vim.keymap.set("n", "<leader>pD", workspaces.remove, { desc = "[P]roject [D]elete" })

-- Diagnostic keymaps
vim.keymap.set("n", "<leader>cd", builtin.diagnostics, { desc = "[C]ode [D]iagnostics" })
vim.keymap.set("n", "<leader>cN", vim.diagnostic.goto_prev, { desc = "Go to previous Diagnostic message" })
vim.keymap.set("n", "<leader>cn", vim.diagnostic.goto_next, { desc = "Go to [N]ext Diagnostic message" })
vim.keymap.set("n", "<leader>cx", vim.diagnostic.open_float, { desc = "Show diagnostic [E]rror messages" })
vim.keymap.set("n", "<leader>cq", vim.diagnostic.setloclist, { desc = "Open diagnostic [Q]uickfix list" })
vim.keymap.set("v", "<leader>cc", "gc", { desc = "[C]ode [C]omment" })
...
vim.keymap.set("n", "<leader>w=", "<C-w>=", { desc = "[W]indows equal side" })
vim.keymap.set("n", "<leader>w+", "<C-w>+", { desc = "[W]indow increase hight" })
vim.keymap.set("n", "<leader>w-", "<C-w>-", { desc = "[W]indow decrease hight" })
...
-- Ctrl-w + arrow keys
vim.keymap.set("n", "<C-w><left>", "<C-w><C-h>", { desc = "Move focus to the left window" })
vim.keymap.set("n", "<C-w><right>", "<C-w><C-l>", { desc = "Move focus to the right window" })
vim.keymap.set("n", "<C-w><up>", "<C-w><C-k>", { desc = "Move focus to the upper window" })
vim.keymap.set("n", "<C-w><down>", "<C-w><C-j>", { desc = "Move focus to the lower window" })
-- Alt + Arrow Keys
...
vim.keymap.set("n", "<leader>hv", builtin.help_tags, { desc = "[H]elp [V]im" })

-- Buffers
vim.keymap.set("n", "<leader>bb", builtin.buffers, { desc = "list buffers" })
vim.keymap.set("n", "<leader>bk", vim.cmd.bdelete, { desc = "[B]uffer [k]ill" })
vim.keymap.set("n", "<leader>bn", vim.cmd.bn, { desc = "[B]uffer [N]ext" })
vim.keymap.set("n", "<leader>bp", vim.cmd.bp, { desc = "[B]uffer [P]rev" })
...
-- Git
vim.keymap.set("n", "<leader>gg", neogit.open, { desc = "[G]et [G]it" })

-- NOTE: Setup Extra Functionality

-- Open file at last location
scripts.file_open_last_location()

-- Setup colored parrends
